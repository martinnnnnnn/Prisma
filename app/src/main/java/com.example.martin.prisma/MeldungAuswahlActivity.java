...
public class MeldungAuswahlActivity extends AppCompatActivity {
    ...
    public void initializeButtons(){
        ...
        mapButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MeldungAuswahlActivity.this, MapsActivity.class));
            }
        });
        ...
        toplistButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MeldungAuswahlActivity.this, Toplist.class));
            }
        });
        b1p4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MeldungAuswahlActivity.this, Eventsmaske.class));
            }
        });
        b6p2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MeldungAuswahlActivity.this, Profil.class));
            }
